  ...
  public class AnimationClipsEditor : EditorWindow
  {
    ...
    private VisualElement CreateManager()
    {
      ...
      generateClipsButton.clicked += () =>
      {
        ...
        {
          Slice(obj, _pixelsPerUnit, _cellSize);
    ...
    public static void Slice(UnityEngine.Object obj, int pixelsPerUnit, Vector2 cellSize)
    {
      ...
      Rect[] rects = InternalSpriteUtility.GenerateGridSpriteRectangles(texture, offset, cellSize, padding, false);
    ...
    public static void CreateClips(UnityEngine.Object obj, string name)
    {
      Texture2D texture = obj as Texture2D;
