...
namespace RFG
{
  ...
  public class InfiniteScroll : MonoBehaviour
  {
    ...
    [field: SerializeField] private int XDivisions { get; set; } = 1;
    [field: SerializeField] private int YDivisions { get; set; } = 1;
    ...
    private void Start()
    {
      ...
      _textureUnitSizeX = (texture.width / sprite.pixelsPerUnit / XDivisions) * transform.localScale.x;
      _textureUnitSizeY = (texture.height / sprite.pixelsPerUnit / YDivisions) * transform.localScale.y;
    }
